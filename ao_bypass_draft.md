...
_[figure: baselines_table.png]_
_Table 1: Target Baseline and Oracle Control Baseline — mean StrongREJECT score (± SE across prompts), average within-prompt standard deviation across rollouts, and ASR at thresholds > 0, ≥ 0.3, ≥ 0.5, ≥ 0.8, and = 1.0._
...
_[figure: user_prompt_oracle_score_table.png]_
_Table 2: User Prompt Oracle mean StrongREJECT score (± SE across prompts) and average within-prompt standard deviation across oracle rollouts, by activation slice and oracle prompt._
...
_[figure: user_prompt_oracle_asr_table.png]_
_Table 3: User Prompt Oracle ASR (± SE across prompts) at thresholds > 0, ≥ 0.3, ≥ 0.5, ≥ 0.8, and = 1.0._
...
_[figure: target_rollout_oracle_score_table.png]_
_Table 4: Target Rollout Oracle mean StrongREJECT score (± SE across prompts) and average within-prompt standard deviation across target rollouts, by activation slice and oracle prompt._
...
_[figure: target_rollout_oracle_asr_table.png]_
_Table 5: Target Rollout Oracle ASR (± SE across prompts) at thresholds > 0, ≥ 0.3, ≥ 0.5, ≥ 0.8, and = 1.0._
...
_[figure: conditional_target_rollout_oracle_refusal_score_table.png]_
_Table 6: Target Rollout Oracle results restricted to rollouts the target model refused (target score = 0) — mean StrongREJECT score (± SE across prompts) and average within-prompt standard deviation across target rollouts._
...
_[figure: user_prompt_oracle_prompt_comparison_table.png]_
_Table 7: User Prompt Oracle mean scores (± SE) under Oracle Prompt A and Oracle Prompt B, by activation slice._

_[figure: target_rollout_oracle_prompt_comparison_table.png]_
_Table 8: Target Rollout Oracle mean scores (± SE) under Oracle Prompt A and Oracle Prompt B, by activation slice._
...
_[figure: main_score_table.png]_
_Table A1: Mean StrongREJECT score (± SE across prompts) for every condition, activation slice, and oracle prompt, with average within-prompt standard deviation across oracle rollouts (User Prompt Oracle) and across target rollouts (Target Rollout Oracle)._

_[figure: main_asr_table.png]_
_Table A2: Attack success rate (± SE across prompts) at thresholds > 0, ≥ 0.3, ≥ 0.5, ≥ 0.8, and = 1.0 for every condition, activation slice, and oracle prompt._

_[figure: conditional_compliance_counts.png]_
_Table A3: Per-prompt breakdown of compliant vs. refusal rollouts in the Target Baseline, showing that baseline compliance is concentrated in a small number of prompts._
